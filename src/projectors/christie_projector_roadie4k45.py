...
class ProjectorRoadie4K45(ChristieProjector):
	def __init__(self, name : str, IP : str, PORT : str):
		...
		self.temperature_thresholds = {
			'Integrator Rod Temperature (Temp 1)': 80,
			'Prism Temperature (Temp 7)': 60,
			'Air Intake Temperature (Temp 2)': 62,
			'Lamp Exhaust Temperature (Temp 3)': 95,
			...
			'DMD-Red Temperature (Temp 4)': 65,
			'Formatter-Green Temperature': 82,
			'DMD-Green Temperature (Temp 5)': 65,
			'Formatter-Blue Temperature': 82,
			'DMD-Blue Temperature (Temp 6)': 65,
